...
class KeywordSuggest extends Component {
    ...
    render() {
        ...
        // let title = (this.props.suggestions) ?  <h4 className={this.props.suggestions.loading ? "red" : "green"}>Suggestion list with Redux  </h4> : <h4>Suggestion list with Redux  </h4> 
       
        return (
        <div className="row">
                <div className="col-sm-6">    
                    <h4>Suggestion list with Redux</h4>
                <KeywordInput />      
